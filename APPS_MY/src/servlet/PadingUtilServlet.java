...
public class PadingUtilServlet extends HttpServlet {
	...
	private ArrayList<Detection> getResultStatisticList(String shorttile,
		...
		if(!"".equals(shorttile) && "".equals(starttime) && "".equals(endtime)){
			sql = "SELECT TOP  "
					+ item
					+ " CONVERT(varchar(19),a.testingtime,120),cast(a.detection1 as decimal(18,2)),cast(a.detection2 as decimal(18,2)),cast(a.detection3 as decimal(18,2)),cast(a.detection5 as decimal(18,2)) ,cast(a.detection10 as decimal(18,2)),cast(a.detection11 as decimal(18,2)),cast(a.detection12 as decimal(18,2)),cast(a.detection13 as decimal(18,2)) ,cast(a.detection14 as decimal(18,2)),cast(a.detection15 as decimal(18,2)) "+
		...
		try {
			...
			if (resultSet != null) {
				...
				while (resultSet.next()) {
					...
					det.setDetection1(resultSet.getString(2));
					det.setDetection2(resultSet.getString(3));
					det.setDetection3(resultSet.getString(4));
					det.setDetection5(resultSet.getString(5));
					det.setDetection10(resultSet.getString(6));
					det.setDetection11(resultSet.getString(7));
					det.setDetection12(resultSet.getString(8));
					det.setDetection13(resultSet.getString(9));
					det.setDetection14(resultSet.getString(10));
					det.setDetection15(resultSet.getString(11));
					list.add(det);
				}
