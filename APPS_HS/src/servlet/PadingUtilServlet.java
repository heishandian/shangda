...
public class PadingUtilServlet extends HttpServlet {
	...
	private ArrayList<Detection> getResultStatisticList(String short_title,
			Integer pagingnum, Integer item, String start_time,String end_time) {
		String sql=null;
		sewageid = new Sewage().getSewageidByShort_title(short_title);;//获取站点的站点id
		if (pagingnum < 0) {
			pagingnum = 1;
		}
	...
	private PadingUtil getCount(String short_title,
			Integer pagingnum, Integer items, String start_time,String end_time){
		String sql = null;
		//查询指定站点的全部数据
